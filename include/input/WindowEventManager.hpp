...
class WindowEventManager : public EventManager {
 ...
 public:
   ...
   * (deprecated)
   */  
  uint64_t RegisterKeyListener(int key, std::function<void(int, int, int)> callback) override;
  KeyListener CreateKeyListener(int key, std::function<void(int, int, int)> callback) override;
   ...
   *  (deprecated)
   */ 
  uint64_t RegisterClickListener(std::function<void(MouseEvent)> callback) override;
  ClickListener CreateClickListener(std::function<void(MouseEvent)> callback) override;
   ...
   */ 
  bool RemoveKeyListener(uint64_t event_id) override;
  void RemoveKeyListener(KeyListener& k) override;
   ...
   */ 
  bool RemoveClickListener(uint64_t event_id) override;
  void RemoveClickListener(ClickListener& c) override;
