 ...
 */ 
std::shared_ptr<engine::EngineContext> CreateContext(GLFWwindow* window, std::shared_ptr<engine::Scene> scene);
 ...
 */ 
void UpdateCtx(double delta, engine::EngineContext* ctx);
